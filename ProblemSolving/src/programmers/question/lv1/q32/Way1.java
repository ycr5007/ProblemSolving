package programmers.question.lv1.q32;
...
public class Way1 {
	...
	public static int expandArray(int[][] board, int[] moves) {
		int count = 0;
...
//			System.out.println("────── " + moves[i] + " ──────");
	...
	public static int solution(int[][] board, int[] moves) {
		return expandArray(board, moves);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(solution(arr, mov));
...
/*
	정확성  테스트
		테스트 1 〉	통과 (0.05ms, 70.3MB)
		테스트 2 〉	통과 (0.07ms, 73.4MB)
		테스트 3 〉	통과 (0.05ms, 72.2MB)
		테스트 4 〉	통과 (0.90ms, 74.2MB)
		테스트 5 〉	통과 (0.08ms, 73.9MB)
		테스트 6 〉	통과 (0.08ms, 77.7MB)
		테스트 7 〉	통과 (0.14ms, 72.2MB)
		테스트 8 〉	통과 (0.26ms, 66MB)
		테스트 9 〉	통과 (0.38ms, 78.7MB)
		테스트 10 〉	통과 (0.26ms, 70.6MB)
		테스트 11 〉	통과 (0.90ms, 83.1MB)
