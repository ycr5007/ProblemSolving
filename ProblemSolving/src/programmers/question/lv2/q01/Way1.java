package programmers.question.lv2.q01;
...
public class Way1 {
	...
	public int solution(String s) {
        int answer = 0;
        int count; // 반복된 횟수를 저장하는 변수
        for(int i = 0; i < s.length(); i++) { // 문자열을 자르는 key 값 반복문
        	for(int j = 0; j < s.length(); j = j + (i + 1)) { // 문자열의 인덱스를 변경해줄 반복문
